# linux-builder
利用 GitHub Actions 自动编译 Linux 内核为 deb 包（也可以为其他类型）。

# 如何使用
如果您想要利用我的这个自动化脚本根据自己的需求编译内核，请参考如下步骤：

#### 1. Fork 仓库
访问 [https://github.com/Mejituu/linux-builder](https://github.com/Mejituu/linux-builder) ，点击右上角的 `Fork` 按钮，并 clone 到本地
